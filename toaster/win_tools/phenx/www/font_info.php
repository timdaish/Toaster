...
//print_r($_REQUEST);  // GET fails under php 7
//echo ("font_info GET fontfile = '" . $_REQUEST["fontfile"]."'");
...
else // request needed for PHP 7
  if (isset($_REQUEST["fontfile"])) {
    //$fontfile = basename($_GET["fontfile"]);
    $fontfile = $_REQUEST["fontfile"];
    $fontfile = "$fontfile";
  }
  else{
    return false;
