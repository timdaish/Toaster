...
if (system.args.length === 1) {
    ...
    var outfile = 'tmp/'+system.args[6];
	var username = system.args[7];
	var password = system.args[8];
	//console.log("SJS ua :" + uastring);
	//console.log("SJS us :" + username);
	//console.log("SJS pw :" + password);
    page.resources = [];
	...
	{
		//console.log('SJS adding authentication: '+ username + " " + password);
