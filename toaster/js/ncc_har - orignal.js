	...
	$.each(HARpages.pages, function(i,val) {
		...
		var options = {
			...
			'credits':{
                ...
                'text': '© 2015 NCC Group Web Performance',
                'href': 'https://www.nccgroup.com/en/our-services/website-performance/',
				},
			'plotOptions':{
				'series':{
					'stacking':'normal',
